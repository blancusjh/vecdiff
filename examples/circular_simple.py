...
ax, _ = plot_field_polarization(E_focal, half_size=5.0)
...
ax.set(title="Propagated circular polarization (polar layout)", xlabel=r"$x/\lambda$", ylabel=r"$y/\lambda$")
save(ax, "propagated_polarization_polar")
