...
from references.legacy.vecdiff.CartesianSurfaces import CartesianSurface
from references.legacy.vecdiff.fresnel import FresnelOvoid
from references.legacy.vecdiff.geometry import (
    ReferenceSphere,
    TangentPlane,
    grazing_radius,
    image_sphere,
...
from references.legacy.vecdiff.reference.currents import PrescribedSphericalCapCurrents
from references.legacy.vecdiff.reference.stratton_chu import franz_integral_chunked
from references.legacy.vecdiff.transfer import (
...
def _uniform_pupil_field(surface, aperture, n_r=2001):
    from references.legacy.vecdiff import Field, Grid
...
def test_package_reproduces_the_exact_focal_field():
    ...
    low and misshapen.
    """
    from references.legacy.vecdiff.pupil_mapping import debye_prefactor
...
def test_plane_referenced_input_is_remapped_onto_the_sphere():
    ...
    from references.legacy.vecdiff import Field, Grid
    from references.legacy.vecdiff.geometry import TangentPlane
    from references.legacy.vecdiff.propagation import incident_field_on_sphere
...
def test_sphere_referenced_input_passes_through_untouched():
    from references.legacy.vecdiff import Field, Grid
    from references.legacy.vecdiff.geometry import ReferenceSphere, incident_sphere
    from references.legacy.vecdiff.propagation import incident_field_on_sphere
...
def test_pupil_mapping_round_trips():
    from references.legacy.vecdiff.pupil_mapping import (
        MAPPINGS,
        pupil_coordinate,
...
def test_paraxial_fresnel_matches_the_exact_coefficients(params):
    ...
    """
    from references.legacy.vecdiff.fresnel import FresnelOvoidParax
...
def test_paraxial_channel_weights_match_the_exact_weights(params):
    ...
    """
    from references.legacy.vecdiff.transfer import focal_channel_weights, paraxial_channel_weights
...
def test_focal_channel_weights_agree_with_the_propagator(params):
    ...
    from references.legacy.vecdiff.pupil_mapping import pupil_weight
    from references.legacy.vecdiff.transfer import focal_channel_weights
