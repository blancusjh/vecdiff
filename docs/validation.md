...
check their embedded PNG figures, and exercise the six maintained example
workflows. Historical runs that included the removed solver are not current suite
results.
